...
git clone https://github.com/jooray/humanizer.git ~/.claude/skills/humanizer
```
...
git clone https://github.com/jooray/humanizer.git ~/.config/opencode/skills/humanizer
```
