...
Voice samples calibrate style only. They do not supply facts, examples, metaphors, or phrases for the rewrite, and repeated scaffolding across several samples is treated as a habit to remove instead of a voice marker to copy.
...
- **2.13.1** - Separated voice calibration from source evidence. Samples now teach cadence, vocabulary, and register without authorizing facts, claims, examples, metaphors, or distinctive phrases in the rewrite. When several samples share an opening formula or section scaffold, the skill treats that repetition as a template to remove rather than part of the author's voice. The final claim-preservation audit now states explicitly that a voice sample is not source material. No change to the 54 patterns.
